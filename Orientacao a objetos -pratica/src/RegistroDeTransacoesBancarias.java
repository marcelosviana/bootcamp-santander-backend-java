...
public class RegistroDeTransacoesBancarias {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Digite o saldo inicialda conta :");
        double saldo = scanner.nextDouble();
       

        // Lê a Entrada com a quantidade total de transações
        System.out.println("Digite a quantidade de transaçôes");
        ...
        for (int i = 1; i <= quantidadeTransacoes; i++) {
            ...
            System.out.println("Digite o tipo da transação: D para depósito ou S para saque ");
